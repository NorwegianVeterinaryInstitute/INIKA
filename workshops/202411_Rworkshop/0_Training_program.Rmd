...
> Data from Human sampling (KoboToolbox)
...
-   First steps in data analysis
    ...
    -   Obtaining a fast overview of the data contained in a dataframe (Explain what is a dataframe)
...
> WHONET fake data for learning + data from Human sampling (KoboToolbox)
...
- removing objects from memory (If time permits, dput trick)
  - notion of identity in objects and memory pointers 
  
-   merging data frames using dplyr (inner, left, right, full)
