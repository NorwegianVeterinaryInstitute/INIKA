...
-   [ ]  **Rscript to run to install packages ? or Renv ?** Need to do one and try - this could help - MUST be done at the end of course prep however to be sure we have all
