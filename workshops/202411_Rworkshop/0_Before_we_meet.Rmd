...
The YOU, three month from now might not remember the reasoning and all the 
steps you have done in your analyses, documenting what you are doing at the 
same time you are doing the analyses is a very good practice. This will save
you time and struggles. What you have done will be essential information
...
like Git, and eventually associated online platform like github that allows 
to store your code on the web. Github can be then be used during the publication 
process, to create a DOI for your code.


Zenodo eg. can help you create a doi from any code store in github, allowing people
to cite your data analysis work!. 
