...
params:
  title: "01 - Introduction: State of mind and Ressources" 
...
so can become independent learners 
- 2. Learn the basics of data wrangling, exploration and visualization and analysis using R,
...
![Humor and markdown way to insert images in markdown!](https://i.redd.it/ms8u3bl2kw351.jpg) {.width=50%}
...
The resources for learning are not lacking. 

What is lacking well is type to 
explore it all ! and know what to search for. How how can you search for 
something you do not know exists yet ?

## What to expect about the code you produce

Learning to write code, is learning how to get up after stumbling... and there is
a lot of stumbling is totally normal. 
...
![What to expect in code?](https://miro.medium.com/v2/resize:fit:1400/0*_lbfkH2RdWvQyLSQ.png)

## What about AI 


AI, for sure can help you find resources and even to help you do some coding for 
you (eg. ChatGTP, GitHub Copilot, etc.). 

**BUT!** Should you use it - I would not advise you to trust blindly the code it 
delivers (could be wrong and difficult to detect its wrong). Should you use it, 
you need to understand what it does. Consequently, you need to have learn
enough to be able to do so! 


# Some Ressources to learn more R 

Here I link several external resources. Some contain material that we have seen 
here but presented differently. They will help you go further. 
...
-   R Books for specific themes (incl., online books) such as [An
    ...
    https://bookdown.org/yihui/bookdown/) and the book for the nice visualisation
    plots [ggplot2](https://ggplot2-book.org/), and many others ... 
    you cant read them all!
...
-   Tutorials eg. [Setting up a reproducible
    ...
    to find one treating AMR [R for AMR
    epidemiology](https://github-pages.arc.ucl.ac.uk/r-amr-epidemiology/index.html)
...
-   Some usefull tricks [here for Rstudio](https://swcarpentry.github.io/git-novice/instructor/04-changes.html)
    

    
-   ...

- [R for AMR epidemiology package](https://github-pages.arc.ucl.ac.uk/r-amr-epidemiology/)
