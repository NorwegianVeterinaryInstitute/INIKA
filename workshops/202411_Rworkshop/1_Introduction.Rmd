...
- 4. We hope that at the end of this course, you have learned enough to be able to use the additional resources and pointers provided in those documents to learn further, and independently about reproducible research and data analysis.  
# The last part of the sentence is a bit odd, wonder if you mean: you have learned enough to be able to use the additional resources and pointers provided in those documents and links provided to gain more knowledge about reproducible research and data analysis and to be able to work independently. See if this is better? 
...
![Humor and markdown way to insert images in markdown!](https://i.redd.it/ms8u3bl2kw351.jpg)
...
this is your responsability. Consequently, you need to have learn
...
NB, you will find also some additional resources through the course.  
